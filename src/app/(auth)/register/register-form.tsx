...
export function RegisterForm({ initialBranding, planId }: { initialBranding?: BrandingInfo; planId?: string }) {
  ...
  return (
    <div className="w-full max-w-lg bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 shadow-xl relative z-10">
          ...
          {logoDataUrl ? (
            <div className="flex items-center gap-3 p-3 border border-indigo-100 bg-indigo-50/50 rounded-xl">
              ...
              <button
                ...
                className="p-2 rounded-lg text-slate-500 hover:text-rose-600 hover:bg-white transition"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition shadow-sm"
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition shadow-sm"
              />
              <button
                type="button"
      ...
      <div className="mt-6 pt-5 border-t border-slate-100 text-center text-xs text-slate-500">
        ...
        <Link href={loginUrl} className="font-semibold text-indigo-600 hover:text-indigo-700 hover:underline">
          Fazer login
        </Link>
